...
- **Post-FOMC meeting**: Immediately process statement diff; **on a projection meeting (March / June / September / December), also process the SEP / dot plot (Type I) the same day** — diff vs. the prior quarterly SEP, evaluate against the inter-meeting speeches, write the alert to `data/reports/fomc/` (emailed on push), and fold it into the next morning's canonical report; schedule minutes processing for ~3 weeks out; **update the reference FOMC date in CLAUDE.md and in all subsequent scored files and daily reports** — the reference date must always reflect the most recent FOMC meeting. Current reference FOMC: **July 29, 2026** (statement HOLD 3.50–3.75%, vote 9–3; sole change: "elevated" → "somewhat elevated" on inflation; Hammack/Kashkari/Logan dissented for +25bp hike — first pro-hike dissent coalition since the active tightening cycle; NOT a projection meeting, no SEP; next meeting Sep 15–16, 2026 IS a projection meeting).
